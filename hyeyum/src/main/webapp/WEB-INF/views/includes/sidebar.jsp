                ...
                <nav class="sidebar-nav">
                    ...
                    <sec:authorize access="hasRole('ROLE_PROFESSOR')">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse first-level base-level-line">
                                <li class="sidebar-item"> <a class="has-arrow sidebar-link" href="javascript:void(0)"
                                    ...
                                    <ul aria-expanded="false" class="collapse second-level base-level-line">
                                        <li class="sidebar-item"><a href="#" <%-- href="${pageContext.request.contextPath}/admin/tuitionlist" --%> class="sidebar-link"><span
                                ...
                                <li class="sidebar-item"> <a class="has-arrow sidebar-link" href="javascript:void(0)"
                                    ...
                                    <ul aria-expanded="false" class="collapse second-level base-level-line">
                                        <li class="sidebar-item"><a href="#" <%-- href="${pageContext.request.contextPath}/admin/scholarship" --%> class="sidebar-link"><span
                                                    class="hide-menu"> 장학금 지급
                                                    </span></a></li>
                                        <li class="sidebar-item"><a href="#" <%-- href="${pageContext.request.contextPath}/admin/scholarshiplist" --%> class="sidebar-link"><span
                                ...
                                <li class="sidebar-item"> <a class="has-arrow sidebar-link" href="javascript:void(0)"
                                    ...
                                    <ul aria-expanded="false" class="collapse second-level base-level-line">
                                        <li class="sidebar-item"><a href="#" <%-- href="${pageContext.request.contextPath}/admin/salary" --%> class="sidebar-link"><span
                                                    class="hide-menu"> 교직원 급여지급
                                                    </span></a></li>
                                        <li class="sidebar-item"><a href="#" <%-- href="${pageContext.request.contextPath}/admin/salarylist" --%> class="sidebar-link"><span
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse first-level base-level-line">
                                <li class="sidebar-item"> <a class="has-arrow sidebar-link" href="javascript:void(0)"
                                    ...
                                    <ul aria-expanded="false" class="collapse second-level base-level-line">
                                        <li class="sidebar-item"><a href="#" <%-- href="${pageContext.request.contextPath}/student/tuition" --%> class="sidebar-link"><span
                                                    class="hide-menu">등록금 납부 
                                                    </span></a></li>
                                        <li class="sidebar-item"><a href="#" <%-- href="${pageContext.request.contextPath}/student/tuitionlist" --%> class="sidebar-link"><span
                                ...
                                <li class="sidebar-item"> <a class="has-arrow sidebar-link" href="javascript:void(0)"
                                    ...
                                    <ul aria-expanded="false" class="collapse second-level base-level-line">
                                        <li class="sidebar-item"><a href="#" <%-- href="${pageContext.request.contextPath}/student/scholarshiplist" --%> class="sidebar-link"><span
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="#" <%-- href="${pageContext.request.contextPath}/professor/salarylist" --%> class="sidebar-link"><span
